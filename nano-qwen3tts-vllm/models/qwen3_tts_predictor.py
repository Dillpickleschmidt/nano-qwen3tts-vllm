...
class Qwen3TTSCodePredictorModel(nn.Module):
    def __init__(self, config, talker_config=None):
        ...
        # codec_embedding uses talker's hidden_size since it embeds outputs from the talker
        embedding_dim = talker_config.hidden_size if talker_config else config.hidden_size
